...
def main():
    ...
    parser.add_argument('--images_path', type=str, default='/kaggle/input/diorvn/dior/JPEGImages',
                        help='path to dataset splits data folder')
    parser.add_argument('--anno_path', type=str, default='/kaggle/input/diorvn/dior/Annotations',
